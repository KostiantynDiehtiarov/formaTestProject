...
**[Демо-версія](https://forma-qr-project.vercel.app)**
...
- ✅ **Зміна дизайну і бекграйнду, декілька A/B тестів**: колір, розмір, логотип у центрі
...
- ✅ **Аналітика**: відстеження кількості сканувань і іх типазація
